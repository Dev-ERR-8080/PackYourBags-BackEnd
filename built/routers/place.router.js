...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, places_model_1.PlacesModel.countDocuments()];
            case 1:
                placesCount = _a.sent();
                if (placesCount > 0) {
                ...
                return [4 /*yield*/, places_model_1.PlacesModel.create(data_1.Sample_Plces)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, places_model_1.PlacesModel.find()];
            case 1:
                places = _a.sent();
                res.send(places);
                return [2 /*return*/];
...
router.get("/search/:searchTerm", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var searchRegex, filteredPlaces;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                searchRegex = new RegExp(req.params.searchTerm, 'i');
                return [4 /*yield*/, places_model_1.PlacesModel.find({
                        $or: [
            ...
            case 1:
                filteredPlaces = _a.sent();
                res.send(filteredPlaces);
                return [2 /*return*/];
        }
    });
}); }));
router.get("/:placeId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var place;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, places_model_1.PlacesModel.findById(req.params.placeId)];
            case 1:
                place = _a.sent();
                res.send(place);
                return [2 /*return*/];
