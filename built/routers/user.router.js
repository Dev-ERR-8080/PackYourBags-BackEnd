        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("user name and password not valid!");
                }
                return [2 /*return*/];
        }
    });
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, phone, user, encryptedpassword, newuser, dbuser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("User Is Already exist!");
                    return [2 /*return*/];
                }
